        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-9">
            <p>
              ...
              day-to-day life. I do not really have a focus area or agenda for what I plan to write
              and upload on this site. Whatever comes to my mind in the moment and that I want to
              share with random strangers on the Internet is what I plan to post. But, of course, if
              you have any ideas, suggestions, topics, or questions that you would like me to cover
              in a future article, simply{' '}
            ...
            <p>
              You might be asking, &quot;who am I?&quot;. And, that is a great question. I am a full
              stack software engineer. Specifically, I tend to focus on front end web development
              but also enjoy digging deep into the backend when needed. I love building websites and
              deploying what I make to the Interent so that it is available for others to see, use,
              and interact with. If you would like to know more about my developer journey and more
              details on how I got into coding specifically, I make developer and coding-oriented
              content on TikTok. Check me out at{' '}
              <a
